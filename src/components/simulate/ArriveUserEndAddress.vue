<template>
  <div class="simulate-arrive-user-end-address" @click="clickFullSimulatePage">
    ...
    <img v-if="clickElem == 'endToCost'" class="jiesuanDialogImg" :src="require('@/static/images/jiesuan_dialog.png')" :style="{ zIndex: clickElem == 'endToCost' ? '9999' : '' }" @click.stop="simulateClickEvent">
...
<script>
export default {
  name: 'simulate-arrive-user-end-address',
  props: {
    shadeLimit: {
      default: 0.6
    },
    clickElem: {
      default: 'phoneCallToUser' // phoneCallToUser、hasToOrderAddress、endToCost
    },
    tipSrc: {
      default: null
    },
...
.simulate-arrive-user-end-address {
  position: relative;
  text-align: left;
  height: 100%;
