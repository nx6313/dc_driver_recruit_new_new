...
export default {
  ...
  created () {
    ...
    this.audio_orderGaipai = new Audio()
    this.audio_orderGaipai.src = require('@/static/sounds/orderGaipai.mp3')
  ...
  methods: {
    ...
    playSound (key) {
      ...
      if (key === 0) {
        ...
        // 播放 改派说明
        this.curPlayingSound = this.audio_orderGaipai
      } else if (key === 4) {
        // 播放 点击按钮去接乘客
